...
<nav style="text-align:center;margin-left: 30%; margin-top: -2%; width:50%">
  <h2>Admin Dashboard</h2>
  <a href="../landing2.html"><button class="btn btn-outline-primary" type="button">Logout</button></a>
</nav>
<hr><br><br>
<!----------iframe------------->
<iframe src="page1.html" frameborder="0" name="iframe" style="position:absolute; width:70%; height: 55em; margin-left:25%; border: outset gray 3px;"> </iframe>
    <!-- Main sidebar -->
<div class="asid"  style =" width: 24%; position:absolute; margin-right:37%; margin-top: -4%; padding-left:2%;">
