...
<body>
    ...
    ?>
            ...
            <form action="" method="GET">
                ...
                <div class="product-card" style="display:inline-block; margin-left:10%; margin-top:4%">
       ...
       ON products.category_id=categories.category_id;";
        ...
        <div style="text-align:center" class="col-lg-10">
            ...
            if (mysqli_num_rows($result1) > 0) {
                ...
                echo '  <ul type="none" class="pagination" style="justify-content: center!important;display:flex; padding:3%">';
                if ($page > 1) {
                    echo '<li   class="paginate_button page-item previous" id="zero_config_previous"><a href="store.php?page=' . ($page - 1) . '" aria-controls="zero_config" data-dt-idx="0" tabindex="0" class="page-link"style="background-color: #bd2130;border-color: #bd2130!important;padding:3%;"  >Previous</a></li>';
                }
                for ($i = 1; $i < $total_pages; $i++) {
                    ...
                    echo '<li style:padding:3%; class="paginate_button page-item ' . $active . '"><a href="store.php?page=' . $i . '" aria-controls="zero_config"  class="page-link">' . $i . '</a></li>';
                }
                if ($total_pages > $page) {
                    echo '<li style:padding:3%; class="paginate_button page-item next" id="zero_config_next"><a href="store.php?page=' . ($page + 1) . '" aria-controls="zero_config" data-dt-idx="7" tabindex="0" class="page-link">Next</a></li>';
                }
                echo '</ul>';
